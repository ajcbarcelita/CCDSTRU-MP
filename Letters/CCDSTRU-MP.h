...
int
Cardinality(char Board[][6], int * next)
{

    int cardinality1 = 0, cardinality2 = 0;
    
    if(Board[0][0] == Board[0][2] && Board[0][2] == Board[1][1] && Board[1][1] == Board[2][0] && Board[2][0] == Board[2][2] && Board[2][2] == 'A') //compares with the first element of set S
    {
        cardinality1++; 
    }
    if(Board[0][0] == Board[0][2] && Board[0][2] == Board[1][1] && Board[1][1] == Board[2][0] && Board[2][0] == Board[2][2] && Board[2][2] == 'B') //the first element of set S
    {
        cardinality2++;
    }

    if(Board[3][3] == Board[3][5] && Board[3][5] == Board[4][4] && Board[4][4] == Board[5][3] && Board[5][3] == Board[5][5] && Board[5][5] == 'A') 
    {
        cardinality1++; 
    }
    if(Board[3][3] == Board[3][5] && Board[3][5] == Board[4][4] && Board[4][4] == Board[5][3] && Board[5][3] == Board[5][5] && Board[5][5] == 'B') 
    {
        cardinality2++;
    }

    if(Board[0][4] == Board[1][3] && Board[1][3] == Board[1][4] && Board[1][4] == Board[1][5] && Board[1][5] == Board[2][4] && Board[2][4] == 'A') 
    {
        cardinality1++; 
    }
    if(Board[0][4] == Board[1][3] && Board[1][3] == Board[1][4] && Board[1][4] == Board[1][5] && Board[1][5] == Board[2][4] && Board[2][4] == 'B') 
    {
        cardinality2++; 
    }

    if(Board[3][0] == Board[3][2] && Board[3][2] == Board[4][0] && Board[4][0] == Board[4][2] && Board[4][2] == Board[5][0] && Board[5][0] == Board[5][2] && Board[5][2] == 'A')     
    {
        cardinality1++; 
    }
    if(Board[3][0] == Board[3][2] && Board[3][2] == Board[4][0] && Board[4][0] == Board[4][2] && Board[4][2] == Board[5][0] && Board[5][0] == Board[5][2] && Board[5][2] == 'B')     
    {
        cardinality2++; 
    }
...
int
CardinalityC(char Areas[][2], int * next)
{
...
void
OverCheck(int * over, char Areas[][2], char Board[][6]) //checks if the game is over
{
    int i, j, ctr = 0;
    ...
    if(Areas[0][0] == Areas[1][1] && Areas[1][1] == 'A')
        *over = 1;
    if(Areas[0][0] == Areas[1][1] && Areas[1][1] == 'B')
        *over = 1;
    if(Areas[0][1] == Areas[1][0] && Areas[1][0] == 'A')
        *over = 1;
    if(Areas[0][1] == Areas[1][0] && Areas[1][0] == 'B')
        *over = 1;
}

//this is programmed according to machine project specs
void
NextPlayerMove( int PosR, int PosC, int * over, int * next, int * good, char Board[][6], char Areas[][2])
{
...
void
GameOver(int * over, int * next, char Board[][6], char Areas[][2])
{
    String result[2] = {"B wins", "A wins"};
	
	//basically if player A wins 
    if(*over && !*next && ((Areas[0][0] == Areas[1][1] && Areas[1][1] == 'A') || (Areas[0][1] == Areas[1][0] && Areas[1][0] == 'A'))) {
    	system("cls");
    	printBoard(Board);
    	printf("%s\n", result[1]);
	} 
	...
	else if(*over && *next && ((Areas[0][0] == Areas[1][1] && Areas[1][1] == 'B') || (Areas[0][1] == Areas[1][0] && Areas[1][0] == 'B'))) {
		system("cls");
    	printBoard(Board);
    	printf("%s\n", result[0]);
	}
